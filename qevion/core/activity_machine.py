...
GENERIC_DEFAULT_V1: dict[str, dict[str, str]] = {
    ...
    S.RESOLVING: {T.QUESTION_RESOLVED: S.ENGAGED, T.FIELD_NEEDED: S.COLLECTING, T.AMBIGUITY: S.CLARIFYING, **_COMMON_EXITS},
    S.CLARIFYING: {T.CLARIFIED: S.ENGAGED, T.FIELD_NEEDED: S.COLLECTING, **_COMMON_EXITS},
    S.CONFIRMING: {T.CONFIRMED: S.EXECUTING, T.DENIED: S.COLLECTING, T.AMBIGUITY: S.CLARIFYING, T.FIELD_NEEDED: S.COLLECTING, **_COMMON_EXITS},
    S.EXECUTING: {T.EXECUTED: S.CLOSING, T.SUCCESS_RULE_MET: S.CLOSING, T.EXECUTION_FAILED: S.ENGAGED, T.HANDOFF: S.ESCALATED, T.BLOCKED: S.BLOCKED},
